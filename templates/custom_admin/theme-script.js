...
setTimeout(function(){$('.main-wrapper').append('<div class="sidebar-settings nav-toggle" id="layoutDiv">'+
...
'<img src="/static/assets/img/theme/theme-img-01.jpg" alt="">'+
...
'<a href="../template/index.html"><img src="/static/assets/img/theme/theme-img-01.jpg" alt=""></a>'+
...
'</div>'+
'</div>'+
'</div>');loadJS('/static/assets/js/"/static/',true);},1000);